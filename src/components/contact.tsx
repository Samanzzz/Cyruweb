    ...
    <section id="contact" className="py-16 sm:py-24 bg-primary/5">
      <div className="container px-4">
        <div className="text-center mb-12">
          <h2 className="font-headline text-3xl font-bold text-primary sm:text-4xl">Contact Us</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="flex flex-col justify-center space-y-8">
            ...
            <div>
              <h3 className="font-headline text-2xl font-semibold text-primary mb-4">Our Locations</h3>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
